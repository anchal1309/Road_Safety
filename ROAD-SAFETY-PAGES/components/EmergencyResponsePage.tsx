...
import styles from "../styles/EmergencyResponsePage.module.css";
import emergencyImage from "../assets/emergency-response.jpg";
import emergencyVideo from "../assets/emergency-response-video.mp4";
  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <img
          src={emergencyImage}
          alt="Emergency response on the road"
