...
import styles from "../styles/VehicleMaintenancePage.module.css";
import maintenanceImage from "../assets/vehicle-maintenance.jpg";
import maintenanceVideo from "../assets/vehicle-maintenance-video.mp4";
