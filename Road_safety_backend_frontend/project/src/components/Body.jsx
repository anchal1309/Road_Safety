...
import { ViewMoreButton } from './Courses/ViewMoreButton';
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Link to="/courses/trafficlaws">
                <CourseCard
                  ...
                  description="Master all traffic Laws and their meanings for confident driving."
              ...
              <section className="py-1 px-4"></section><div className='px-4 flex flex-col items-center justify-center'><ViewMoreButton /></div>
