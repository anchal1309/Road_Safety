...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (recommendationForm) {
        recommendationForm.addEventListener('submit', (e) => submitRecommendationFeedback(e, './Recommendation.tsx'));
    }

    if (feedbackForm) {
        feedbackForm.addEventListener('submit', (e) => submitRecommendationFeedback(e, '/Road_safety_backend_frontend/project/src/components/Feedback/FeedbackPage.tsx'));
    }
});
